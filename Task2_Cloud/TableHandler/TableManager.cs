...
namespace Task2_Cloud.TableHandler
{
    public class TableManager
    {
        ...
        public TableManager(string _CloudTableName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=ababc;AccountKey=o8FqlEriXru140NMg9x8SUqKehKjAI9xEr6QPmmoU26yuhPZYQZ3UJ5HqMytMJxhuHQrzRgyPL+/8jXVNH36xw==;EndpointSuffix=core.windows.net";
        ...
        public void InsertEntity<T>(T entity, bool forInsert = true) where T : TableEntity, new()
        {
            try
            {
                if (forInsert)
                {
                    var InsertOperation = TableOperation.Insert(entity); table.Execute(InsertOperation);
                }
                else
                {
